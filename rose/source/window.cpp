...
static float vertices[] = { -0.5f, -0.5f, -0.5f, 0.0f,  0.0f,  0.5f,  -0.5f, -0.5f, 1.0f,  0.0f,  0.5f,  0.5f,  -0.5f,
...
bool WindowGLFW::init() {
    ...
    std::string texture_path1 = "./textures/texture1.jpg";
    unsigned char* data = stbi_load(texture_path1.c_str(), &width, &height, &nr_channels, 0);
    ...
    data = stbi_load("./textures/texture2.png", &width, &height, &nr_channels, 0);
